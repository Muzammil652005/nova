...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "01870204-e352-413a-ae7e-08774984975d",
...
const _lazy_KnUGuZ = () => import('../routes/api/auth/login.post.mjs');
const _lazy_6n90U7 = () => import('../routes/api/contact/_id_.delete.mjs');
const _lazy_6aS6uz = () => import('../routes/api/index.post.mjs');
const _lazy_jqGlR5 = () => import('../routes/api/form/contact.post.mjs');
const _lazy_fMZrAG = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });
...
export { $fetch as $, getContext as A, baseURL as B, createHooks as C, executeAsync as D, toRouteMatcher as E, createRouter$1 as F, defu as G, withLeadingSlash as H, parseURL as I, parseQuery as J, withTrailingSlash as K, withoutTrailingSlash as L, getCookie as a, setUserSession as b, createError$1 as c, defineEventHandler as d, requireUserSession as e, buildAssetsURL as f, getRouteRulesForPath as g, useRuntimeConfig as h, getResponseStatusText as i, joinHeaders as j, getResponseStatus as k, defineRenderHandler as l, getQuery as m, normalizeCookieHeader as n, destr as o, publicAssetsURL as p, getRouteRules as q, readBody as r, setCookie as s, hasProtocol as t, useNitroApp as u, isScriptProtocol as v, joinURL as w, withQuery as x, appendResponseHeader as y, sanitizeStatusCode as z };
