...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const companyTypes = {
      ...
      small: "A widely adopted business structure requiring at least two directors and two shareholders, offering credibility, limited liability, and ease of fundraising."
    };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/services/private_limited.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=private_limited-DawV5BsA.mjs.map
